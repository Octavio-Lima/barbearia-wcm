...
const SELECT_BARBER = document.querySelector("#barber-select") as HTMLSelectElement | null
let serviceList: Array<Service> = []
...
async function LoadBarberServices(barberId: string | number) {
...
class Service {
    ...
    input = {
        service: null as HTMLInputElement | null,
        value: null as HTMLInputElement | null,
        duration: null as HTMLInputElement | null
    }

    constructor(service: string, value: number, duration: string) {
