...
export function ReadEntry(entry, tableIndex) {
...
// Salvar no Banco de Dados
export async function UpdateEntry(id, name, createType, value, payType, datePayed) {
...
export async function LoadAllEntries() {
    ...
    databaseEntryList.forEach((entry, index) => {
