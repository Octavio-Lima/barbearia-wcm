...
export function CurrencyToNumber(valueInCurrency) {
    // Remover simbolos
    let result;
    let value = valueInCurrency.replace('R$ ', '').replace('R$', '');
    let negativeMultiplier; // se for 1 é positivo, se for -1 negativo, usado para saber se o numero é negativo
...
export function ToPhoneNumber(phoneNumber) {
