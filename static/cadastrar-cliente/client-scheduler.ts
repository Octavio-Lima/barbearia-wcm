...
import * as Format from "../geral/js/formating";
import { selectedBarber, shop_id, shop_workDays, shop_opensAt, shop_closesAt, shop_firstWeekDayNumber } from "./main"; // text and number formating
import { warningMsg } from "./scheduler-windows"; // text and number formating
...
let scheduleBlockList: Array<any>;
...
export async function UpdateSchedule() {
    ...
    scheduleBlockList.forEach((schedule: any) => {
...
function DisableSchedule(startHour: number, startMinute: number, scheduleLength: number) {
